...
import {
  ...
  AlertLink_default,
  Alert_default
} from "./chunk-RBWAOYJA.js";
import {
  Anchor_default,
  useCallbackRef,
  useEventListener
} from "./chunk-AUPLQ4XS.js";
import {
  CloseButton_default,
  Fade_default,
...
var Switch = React56.forwardRef((props, ref) => (0, import_jsx_runtime53.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var ModalHeader = React66.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var ModalTitle = React67.forwardRef(({
  className,
  bsPrefix,
...
var Modal = React68.forwardRef(({
  ...
  const renderBackdrop = (0, import_react30.useCallback)((backdropProps) => (0, import_jsx_runtime66.jsx)("div", {
    ...backdropProps,
...
var NavDropdown = React69.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React70.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
...
var PopoverHeader = React71.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React72.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Tooltip = React75.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
...
var Overlay2 = React76.forwardRef(({
  children: overlay,
  ...
  return (0, import_jsx_runtime75.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React76.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime78.jsxs)(import_jsx_runtime77.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react35.cloneElement)(children, triggerProps), (0, import_jsx_runtime76.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React78.forwardRef(({
  ...
  return (0, import_jsx_runtime79.jsx)("li", {
    ...
    children: (0, import_jsx_runtime80.jsxs)(Component2, {
      className: (0, import_classnames62.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime79.jsx)("span", {
...
function createButton(name, defaultValue, label = name) {
  const Button = React78.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime80.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React79.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
  ...
  return (0, import_jsx_runtime81.jsx)("ul", {
    ref,
    ...props,
...
var PlaceholderButton = React80.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime82.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Placeholder = React81.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime84.jsx)("div", {
    ...
    "aria-valuemin": min2,
    "aria-valuemax": max2,
    children: visuallyHidden ? (0, import_jsx_runtime84.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
}
var ProgressBar = React82.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime96.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
...
var ToastFade = React93.forwardRef((props, ref) => (0, import_jsx_runtime98.jsx)(Fade_default, {
  ...props,
  ref,
...
var Toast = React97.forwardRef(({
  ...
  return (0, import_jsx_runtime102.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime102.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
